...
func _ready():
	...
	yield(self,"mouse_click")
	subtitle.hide()
	dialogue(subtitle, "Yare Yare Daze. How old are you? Twelve?")
	subtitle.show()
	yield(self,"mouse_click")
	yield(self,"mouse_click")
	subtitle.hide()
	dialogue(subtitle, "I don't team-up with little girls.")
	subtitle.show()
	yield(self,"mouse_click")
	yield(self,"mouse_click")
	subtitle.hide()
	dialogue(subtitle, "B-b-b-but Kujo-san, I am SAILOR MOON!")
	subtitle.show()
	yield(self,"mouse_click")
	yield(self,"mouse_click")
	subtitle.hide()
	dialogue(subtitle, "And this is my neighborhood.")
	subtitle.show()
	yield(self,"mouse_click")
	yield(self,"mouse_click")
	subtitle.hide()
	dialogue(subtitle, "Shut up! Get out of my way.")
	subtitle.show()
	yield(self,"mouse_click")
	yield(self,"mouse_click")
	subtitle.hide()
	dialogue(subtitle, "You...")
	subtitle.show()
	yield(self,"mouse_click")
	yield(self,"mouse_click")
	subtitle.hide()
	dialogue(subtitle, "You are so rude.")
	subtitle.show()
	yield(self,"mouse_click")
	yield(self,"mouse_click")
	subtitle.hide()
	dialogue(subtitle, "On Behalf of the Moon, I Will Punish You!")
	subtitle.show()
	yield(self,"mouse_click")
	yield(self,"mouse_click")
